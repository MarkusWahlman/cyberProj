...
export const lateAuth = (fn: AuthMiddleware): AuthMiddleware => {
  const wrapped = (req: any, res: any, next: NextFunction) => fn(req, res, next);
...
export const isAuthenticated = markAsAuth((req: Request, res: TypedResponse<ErrorResponse>, next: NextFunction) => {
...
export const isPublic = markAsAuth((_req: Request, _res: TypedResponse<unknown>, next: NextFunction) => {
...
export const localAuth = markAsAuth((req: Request, res: TypedResponse<ErrorResponse>, next: NextFunction) => {
